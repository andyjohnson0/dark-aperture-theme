{combine_css path="themes/dark_aperture/node_modules/selectize/dist/css/selectize.bootstrap3.css"}
{combine_script id='jquery.selectize' load='footer' require='jquery' path="themes/dark_aperture/node_modules/selectize/dist/js/standalone/selectize.min.js"}
