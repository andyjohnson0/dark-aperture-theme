...
{include file="http_scheme.tpl"}
            <img class="gravatar" src="//www.gravatar.com/avatar/{$comment.EMAIL|default:''|trim|strtolower|md5}?d={$http_scheme}://{$smarty.server.HTTP_HOST}/{get_gallery_home_url()}themes/dark_aperture/img/user.png" />
{/if}
        </div>
