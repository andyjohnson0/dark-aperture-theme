{combine_css path="themes/dark_aperture/node_modules/slick-carousel/slick/slick.css" order=-22}
{combine_css path="themes/dark_aperture/node_modules/slick-carousel/slick/slick-theme.css" order=-21}
{combine_script id="slick.carousel" require="jquery" path="themes/dark_aperture/node_modules/slick-carousel/slick/slick.min.js" load="footer"}
