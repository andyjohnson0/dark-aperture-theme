...
$lang['Use colored share buttons instead of icons'] = 'Использовать цветные разделители вместо иконок';
$lang['A mobile-ready theme based on Bootstrap 4'] = 'Тема для мобильных устройств основана на Bootstrap 4';
$lang['Advanced'] = 'Детально';
$lang['Description display style'] = 'Стиль отображения описания';
$lang['Hero image'] = 'Изображение героя';
$lang['Simple'] = 'Просто ';
$lang['Span the full viewport height'] = 'Область просмотра охватывает всю высоту';
$lang['Use 6 colums for viewports >= 1680px'] = '6 колонок в области просмотра - не менее 1680 пикселей';
$lang['center-aligned h5 heading'] = 'центрированный заголовок';
...
$lang['Banner style'] = 'Стиль баннера';
...
$lang['AutoPlay'] = 'Автоплей';
$lang['Close (Esc)'] = 'Закрыть (Esc)';
$lang['Next (arrow right)'] = 'Следующее (стрелка вправо)';
$lang['Picture details'] = 'Детали изображения';
$lang['Previous (arrow left)'] = 'Предыдущее (стрелка влево)';
